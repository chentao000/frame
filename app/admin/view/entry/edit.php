	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="index.html" style="color: white;margin-left: -14px">学生后台管理系统</a>
				</h4>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control"  name="admin_username" placeholder="" value="">
							</div>
						</div>
						<div class="form-group">
...
<div class="master-footer" style="margin-top: 150px">
	<a href="http://www.wubin.pro">学生管理</a>
	<br>
