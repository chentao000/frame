...
<div class="col-xs-12 col-sm-9 col-lg-10">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active"><a href="">学生修改界面</a></li>
    </ul>
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="line-height: 35px">
                        <input type="radio" name="ssex" <?php if ($oldData['ssex']=='男'){ ?>checked="checked" <?php }?> value="男">男
                        <input type="radio" name="ssex" <?php if ($oldData['ssex']=='女'){ ?>checked="checked" <?php }?> value="女">女
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php foreach ($materialData as $k=>$v) { ?>
                            <input type="radio" name="mid" <?php if ($oldData['mid'] == $v['mid']){ ?> checked="checked" <?php }?> value="<?php echo $v['mid'] ?>">
                    ...
                    <div class="col-sm-10">
                        <select name="gid" id="inputID" class="form-control" >
                            ...
                            <?php foreach($gradeData as $v):?>
                                <option <?php if ($oldData['gid'] == $v['gid']){ ?> selected="selected" <?php }?> value="<?php echo $v['gid']?>"> -- <?php echo $v['gname']?> -- </option>
                            <?php endforeach?>
                        </select>
                    </div>
                </div>
